...
const employee = new Employee('Kostya Khait');
employee.displayInfo();

const manager = new Manager('Prosoedova Nika', 'saler');
manager.displayInfo();
...
class Order {
    ...
    getTotalPrice() {
        ...
        for (let i = 0; i < this.products.length; i++) {
            totalPrice += this.products[i].cost;
        }
        return totalPrice;
    }
...
const product2 = new Product('iPad', 70000);
